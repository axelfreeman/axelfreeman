...
> **Marketing Engineer** — I build the systems that turn marketing into code: AI agents, automation, and AEO (AI search visibility). Skills & MCP servers that drop into Claude, Cursor, or ChatGPT in one command.
